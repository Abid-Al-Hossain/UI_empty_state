...
export default function Page() {
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Empty State Studio" headerActions={headerActions} controls={controls} preview={output} /></AppShell>;
}
