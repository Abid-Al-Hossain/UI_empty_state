...
export default function Page() {
  const [state, setState] = useState<EmptyStateState>(DEFAULT_EMPTYSTATE_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Empty State Studio" controls={controls} preview={output} /></AppShell>;
}
